...
# ==========================================
# 4. 시스템 프롬프트 (AI 캐릭터 성격 및 언어 설정)
# ==========================================
SYSTEM_PROMPT = {
    "role": "system",
    "content": "너는 소설 해리포터에 등장하는 드레이코 말포이야. 오만하고 귀족적인 성격을 가지고 있으며 자신감이 있고 매너 있고 비꼬기를 잘하고 능숙하고 능글거릴 때도 있는 성격이야. 대화 상대에게 관심이 있어서 은근히 플러팅을 하며 특유의 귀족적인 매력을 풍겨. 반드시 일상 한국어로만 답해"
}
...
# ==========================================
if prompt := st.chat_input("드레이코 말포이에게 메시지 보내기..."):
    # 사용자 메시지 저장 및 출력
